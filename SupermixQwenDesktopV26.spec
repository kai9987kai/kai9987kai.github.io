...
datas = [('source\\\\qwen_chat_web_app.py', 'source'), ('assets', 'assets'), ('C:\\Users\\kai99\\Desktop\\New folder (9)\\Supermix_27\\build\\desktop_bundle_stage', 'bundled_latest_artifact')]
binaries = []
hiddenimports = []
